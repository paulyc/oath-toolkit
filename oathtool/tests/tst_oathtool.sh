...
dotest "--ocra --suite OCRA-2:HOTP-SHA1-8:C-QN08-PSHA1 --challenge BC614E --challenge-format hex" "fail" fail
dotest "--ocra" "fail" fail
dotest "--ocra --suite OCRA-1:HOTP-SHA1-8:C-QN08-PSHA1 --challenge BC614E --challenge-format=hex --counter 2 --phash 7110eda4d09e062aa5e4a390b0a572ac0d2c0220  3132333435363738393031323334353637383930313233343536373839303132" "61331807"
dotest "--ocra --suite OCRA-1:HOTP-SHA1-8:C-QN08-PSHA1 --challenge BC614E --challenge-format=hex --counter 2 --phash 7110eda4d09e062aa5e4a390b0a572ac0d2c0220 3132333435363738393031323334353637383930313233343536373839303132 61331807" "0"
dotest "--ocra --suite OCRA-1:HOTP-SHA1-8:C-QN08-PSHA1 --challenge BC614E --challenge-format=hex --counter 2 --phash 7110eda4d09e062aa5e4a390b0a572ac0d2c0220 3132333435363738393031323334353637383930313233343536373839303132 61331808" "1" fail
exit 0
